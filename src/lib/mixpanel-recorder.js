(function () {
    ...
    var cssStringDedup = /* @__PURE__ */ new Map();
    var CSS_DEDUP_MAX = 100;
    function cssHash(str) {
        var h = 2166136261;
    ...
    function stringifyStylesheet(s2) {
        try {
            ...
            var result2 = fixBrowserCompatibilityIssuesInCSS(stringifiedRules);
            var h = cssHash(result2);
            var cached = cssStringDedup.get(h);
            if (cached !== void 0 && cached.length === result2.length && cached === result2) {
                return cached;
            }
            if (cssStringDedup.size >= CSS_DEDUP_MAX) {
                var firstKey = cssStringDedup.keys().next().value;
                if (firstKey !== void 0) cssStringDedup.delete(firstKey);
            }
            cssStringDedup.set(h, result2);
            return result2;
        } catch (error) {
            return null;
        }
    ...
    var Mirror = /*#__PURE__*/ function() {
        function Mirror(slimMeta) {
            if (slimMeta === void 0) slimMeta = false;
            __publicField$1$1(this, "idNodeMap", /* @__PURE__ */ new Map());
            __publicField$1$1(this, "nodeMetaMap", /* @__PURE__ */ new WeakMap());
            __publicField$1$1(this, "slimMeta");
            this.slimMeta = slimMeta;
        }
        ...
        _proto.removeNodeFromMap = function removeNodeFromMap(n2, permanent, _depth) {
            var _this = this;
            ...
            if (n2.childNodes) {
                n2.childNodes.forEach(function(childNode) {
                    return _this.removeNodeFromMap(childNode, permanent, _depth + 1);
                });
            }
            if (n2.nodeName === "IFRAME") {
                try {
                    var iframeDoc = n2.contentDocument;
                    if (iframeDoc) {
                        this.removeNodeFromMap(iframeDoc, permanent, _depth + 1);
                    }
                } catch (e2) {}
            }
            if (n2.shadowRoot) {
                this.removeNodeFromMap(n2.shadowRoot, permanent, _depth + 1);
            }
        };
    ...
    function createMirror$2(slimMeta) {
        return new Mirror(slimMeta);
    }
    ...
    function serializeElementNode(n2, options) {
        var doc = options.doc, blockClass = options.blockClass, blockSelector = options.blockSelector, _options_maskInputOptions = options.maskInputOptions, maskInputOptions = _options_maskInputOptions === void 0 ? {} : _options_maskInputOptions, maskInputFn = options.maskInputFn, _options_dataURLOptions = options.dataURLOptions, dataURLOptions = _options_dataURLOptions === void 0 ? {} : _options_dataURLOptions, inlineImages = options.inlineImages, recordCanvas = options.recordCanvas, keepIframeSrcFn = options.keepIframeSrcFn, _options_newlyAddedElement = options.newlyAddedElement, newlyAddedElement = _options_newlyAddedElement === void 0 ? false : _options_newlyAddedElement, rootId = options.rootId;
    ...
    var MutationBuffer = /*#__PURE__*/ function() {
         ...
         */ __publicField$1(this, "addedSet", /* @__PURE__ */ new Set());
            ...
            __publicField$1(this, "emit", function() {
                ...
                while(_this.mapRemoves.length){
                    ...
                    _this.mirror.removeNodeFromMap(removedNode, true);
                }
                _this.iframeManager.cleanupOrphanedIframes();
        ...
        _proto.destroy = function destroy() {
            ...
            this.doc = void 0;
            this.mirror = void 0;
            this.iframeManager = void 0;
            this.stylesheetManager = void 0;
            this.shadowDomManager = void 0;
            this.canvasManager = void 0;
            this.processedNodeManager = void 0;
            this.mutationCb = void 0;
            this.texts = [];
            this.attributes = [];
            this.removes = [];
            this.mapRemoves = [];
            ...
            this.removesSubTreeCache.clear();
            this.movedMap = {};
        };
    ...
    function initObservers(o2, hooks) {
        ...
        var mutationBuffer;
        if (o2.recordDOM) {
            var result2 = initMutationObserver(o2, o2.doc);
    ...
    var IframeManager = /*#__PURE__*/ function() {
        function IframeManager(options) {
            ...
            __publicField$1(this, "attachedIframes", /* @__PURE__ */ new Set());
            __publicField$1(this, "mirror");
            __publicField$1(this, "mutationCb");
        ...
        _proto.cleanupOrphanedIframes = function cleanupOrphanedIframes() {
            if (this.attachedIframes.size === 0) return;
            var stale = [];
            for(var _iterator = _create_for_of_iterator_helper_loose(this.attachedIframes), _step; !(_step = _iterator()).done;){
                var iframeEl = _step.value;
            ...
            if (stale.length > 0) {
                for(var _iterator1 = _create_for_of_iterator_helper_loose(stale), _step1; !(_step1 = _iterator1()).done;){
                    var iframeEl1 = _step1.value;
                    this.removeIframe(iframeEl1);
                }
            }
        };
        ...
        _proto.attachIframe = function attachIframe(iframeEl, childSn) {
            ...
            var oldDoc = this.iframeContentDocumentMap.get(iframeEl);
            if (oldDoc && oldDoc !== iframeEl.contentDocument) {
                ...
                var oldCleanup = this.iframeObserverCleanupMap.get(iframeEl);
                if (oldCleanup) {
                    try {
                        oldCleanup();
                    } catch (e2) {}
    ...
    var ShadowDomManager = /*#__PURE__*/ function() {
        ...
        _proto.addShadowRoot = function addShadowRoot(shadowRoot2, doc) {
            ...
            var _initMutationObserver = initMutationObserver(_extends({}, this.bypassOptions, {
                doc: doc,
                mutationCb: this.mutationCb,
                mirror: this.mirror,
                shadowDomManager: this
            }), shadowRoot2), observer = _initMutationObserver.observer, buffer = _initMutationObserver.buffer;
            this.restoreHandlers.push(function() {
                observer.disconnect();
                var idx = mutationBuffers.indexOf(buffer);
                if (idx !== -1) mutationBuffers.splice(idx, 1);
                buffer.destroy();
            });
       ...
       */ _proto.cleanupStylesheetsForRemovedNode = function cleanupStylesheetsForRemovedNode(removedNode) {
            ...
            try {
                ...
                if (removedNode.shadowRoot) {
                    var shadowRoot2 = removedNode.shadowRoot;
                    if (shadowRoot2 == null ? void 0 : shadowRoot2.adoptedStyleSheets) {
                        for(var _iterator1 = _create_for_of_iterator_helper_loose(shadowRoot2.adoptedStyleSheets), _step1; !(_step1 = _iterator1()).done;){
                            var sheet1 = _step1.value;
                            this.styleMirror.remove(sheet1);
                        }
                    }
                    this.cleanupStylesheetsForRemovedNode(shadowRoot2);
                }
            } catch (e2) {}
        };
    ...
    var mirror = createMirror$2(true);
    function record(options) {
        if (options === void 0) options = {};
        console.log("[rrweb] patched build v9 — mutationBuffers leak fix + kill Walnut rrweb");
        ...
        wrappedEmit = function(r2, isCheckout) {
            ...
            if (e2.type === EventType.FullSnapshot) {
                lastFullSnapshotTimestamp = e2.timestamp;
                ...
                var exceedTime = checkoutEveryNms && e2.timestamp - lastFullSnapshotTimestamp > checkoutEveryNms;
        ...
        var wrappedMutationEmit = function(m) {
            var _a2, _b;
            var isAttach = m.isAttachIframe;
            if (isAttach || m.adds && m.adds.length > 0 || m.removes && m.removes.length > 0) {
                console.log("[rrweb-diag1] mutation: adds=" + (((_a2 = m.adds) == null ? void 0 : _a2.length) || 0) + " removes=" + (((_b = m.removes) == null ? void 0 : _b.length) || 0) + " isAttachIframe=" + !!isAttach + " mirror=" + mirror.size);
            }
            wrappedEmit({
                type: EventType.IncrementalSnapshot,
                data: _extends({
        ...
        try {
            ...
            iframeManager.addLoadListener(function(iframeEl) {
                try {
                    ...
                    if (iframeDoc) {
                        var cleanupObservers = observe(iframeDoc);
                        iframeManager.setObserverCleanup(iframeEl, cleanupObservers);
                        handlers.push(cleanupObservers);
                    }
                } catch (e2) {}
            });
            var init = function() {
    ...
    var dirname = require$$2.dirname, relative = require$$2.relative, resolve$4 = require$$2.resolve, sep = require$$2.sep;
    ...
    RequestBatcher.prototype.flush = function(options) {
        ...
        return this.queue.fillBatch(currentBatchSize)
            .then(_.bind(function(batch) {
                ...
                // Release heavy payload references from batch items.
                // IDs are still needed for removeItemsByID but payloads are not.
                _.each(batch, function(item) {
                    item['payload'] = null;
                });
                        ...
                        .then(_.bind(function (succeeded) {
                            ...
                            if (succeeded) {
                                ...
                                if (this.flushOnlyOnInterval && !attemptSecondaryFlush) {
                                    ...
                                    // Use scheduleFlush(0) instead of recursive this.flush()
                                    // to break the Promise chain and allow closures to be GC'd.
                ...
                var batchSendCallback = _.bind(function(res) {
                    ...
                    try {
                        ...
                        // Release heavy references now that request is complete.
    ...
    console_with_prefix('autocapture');
    ...
    var SessionRecording = function(options) {
        ...
        localStorageSupported(options.sharedLockStorage, true) && !this.getConfig('disable_persistence');
        ...
        this.batcher = new RequestBatcher(this.batcherKey, {
            ...
            sharedLockStorage: options.sharedLockStorage,
            usePersistence: false, // disabled to prevent IDB read/write of full queue on every enqueue (memory leak for large payloads)
    ...
    SessionRecording.prototype._flushEvents = addOptOutCheckMixpanelLib(function (data, options, callback) {
        ...
        if (numEvents > 0) {
            ...
            // Release event objects (with large _cssText strings) now that we have the JSON.
            // This allows GC before the async compress/send completes.
            ...
            if (canUseCompressionStream(userAgent, navigator.vendor, windowOpera)) {
                ...
                eventsJson = null; // release after Blob captures it
