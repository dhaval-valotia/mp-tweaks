(function () {
    ...
    */
    ...
    MixpanelLib.prototype._check_and_start_session_recording = addOptOutCheckMixpanelLib(function(force_start) {
        console.log('[mp-diag] _check_and_start_session_recording called, force_start=' + force_start);
        ...
        var loadRecorder = _.bind(function(startNewIfInactive) {
            console.log('[mp-diag] loadRecorder called, __mp_recorder defined=' + !_.isUndefined(win[RECORDER_GLOBAL_NAME]));
            var handleLoadedRecorder = _.bind(function() {
                try {
                    console.log('[mp-diag] handleLoadedRecorder, creating recorder');
                    this._recorder = this._recorder || new win[RECORDER_GLOBAL_NAME](this);
                    console.log('[mp-diag] recorder created, calling resumeRecording');
                    this._recorder['resumeRecording'](startNewIfInactive);
                } catch(e) {
                    console.error('[mp-diag] handleLoadedRecorder error:', e);
                }
            }, this);

            if (_.isUndefined(win[RECORDER_GLOBAL_NAME])) {
                console.log('[mp-diag] __mp_recorder not found, loading from recorder_src=' + this.get_config('recorder_src'));
        ...
        console.log('[mp-diag] force_start=' + force_start + ' is_sampled=' + is_sampled);
